  ...
  return (
    <section className="bg-[#0a0a0a] text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
        <div className="flex flex-col lg:flex-row lg:items-stretch lg:gap-14 lg:min-h-[620px]">
          <div className="order-2 lg:order-1 lg:flex-1 pt-8 lg:pt-0 flex flex-col lg:min-h-[620px]">
            <div className="flex-1 flex flex-col">
              {activeEvent.tagline && (
                <div className="inline-flex items-center gap-2 bg-amber-500/15 border border-amber-500/30 rounded-full px-4 py-1.5 mb-5 self-start">
              ...
              <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-6 line-clamp-3 max-w-xl min-h-[84px]">
                {activeEvent.description}
              </p>

              <div className="flex flex-col gap-2.5 mb-7 text-sm min-h-[112px]">
            ...
            <div className="pt-2">
              <div className="flex flex-wrap items-center gap-4 min-h-[56px]">
                ...
                {heroCapacity && (
                  <span className="flex items-center gap-1.5 text-xs text-amber-200/70 border border-amber-400/20 rounded-full px-3 py-1.5 min-w-[158px] justify-center">
              ...
              {events.length > 1 && (
                <div className="mt-8 flex items-center gap-3 min-h-[20px]">
          ...
          {activeEvent.imageUrl && (
            <div className="order-1 lg:order-2 lg:w-[48%] lg:flex-shrink-0">
              <div className="relative w-full aspect-video lg:aspect-[4/3] lg:h-[420px] rounded-2xl overflow-hidden shadow-2xl shadow-black/70 ring-1 ring-white/10 bg-[#111]">
                <Image
